...
// Zod schema that matches the invoice shape used in forms
...
export async function createInvoice(formData: FormData) {
  // Coerce potential null values to strings before validation
  const raw = {
  ...
  let customerId: string, amount: number, status: "pending" | "paid";
